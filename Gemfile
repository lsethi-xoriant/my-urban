...
#Remotipart is a Ruby on Rails gem enabling AJAX file uploads with jQuery in Rails 
...
#asset-pipeline gem to provide underscore.js
...
gem 'globalize', '4.0.3'
#ExecJS lets you run JavaScript code from Ruby https://github.com/sstephenson/execjs
gem 'execjs', '2.3.0'
